...
```powershell
git status --short
git add README.md PACKAGE_NOTE.md ARCHITECTURE.md SECURITY.md DEMO_SCRIPT.md SUBMISSION_COPY.md FINAL_SUBMISSION_CHECKLIST.md FORM_READY_ANSWERS.md REPO_RELEASE_PLAN.md COVER_IMAGE_BRIEF.md SCREENSHOT_SHOT_LIST.md REDACTION_CHECKLIST.md PUBLICATION_COMMANDS.md LICENSE_TODO.md .gitignore diagram mock-data
git status --short
